...
import HomePageText from "../../assets/LogoOnPage.png"
import HomePageGraphic from '../../assets/CoverGirl1.png'
...
const Home = ({setSelectedPage}: Props) => {
  ...
  return (
    ...
    >
      ...
      <motion.div 
      className="md:flex mx-auto w-3/4 items-center justify-center md:h-5/6"
      onViewportEnter={() => setSelectedPage(SelectedPage.Home)}
      >
      {/* MAIN HEADER */}
       <div className="z-10 mt-20 md:basis-3/4">
       {/* HEADINGS */}
        <motion.div 
        className="md:-mt-30"
        initial="hidden"
        ...
        >
          <div className="relative">
            <div className="before:absolute before:-top-40 before:-left-40 before:z-[-1] md:before:content-hustletext">
      ...
      <div className="flex basis-3/5 justify-center md:z-10
                md:ml-40 md:mt-16 md:jistify-items-end">
